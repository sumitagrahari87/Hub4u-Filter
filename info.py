...
API_ID = int(environ.get('API_ID', '28757573 6441121104 2015261342'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002121154371').split()]
